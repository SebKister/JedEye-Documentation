  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Sebastien Kister - Ariane's Line. Content licensed under <a href="https://creativecommons.org/licenses/by/4.0/">CC BY 4.0</a>.`,
      },
      prism: {
